...
class WhisperAudio:
    def __init__(self, wav_audio_dir, transcript_dir):
        self.wav_audio_dir = wav_audio_dir
        self.transcript_dir = transcript_dir

    def audio_to_text(self, audio_mp3_path):
        ...
        subprocess.run(
            ["./main", "-m", "./models/ggml-base.en.bin", "-f", f"{os.path.abspath(audio_wav_path)}", "-of", f"{os.path.abspath(transcript_f_path)}", "-otxt"],
